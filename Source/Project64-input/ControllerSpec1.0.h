...
#define CONTROLLER_SPECS_VERSION    0x0100
...
/***** Structures *****/
    ...
    typedef union {
        ...
        struct {
            ...
            signed   X_AXIS : 8;    // swapped with y_axis from nrage spec

            signed   Y_AXIS : 8;    // swapped with x_axis from nrage spec
        };
    } BUTTONS;

    // 1.1 spec structure, modified for WIN32, but used
    typedef struct
    {
        HWND hwnd;
        HINSTANCE hinst;
        BOOL MemoryBswaped;    // Set this to true
